...
export default async function AdminLayout({
  ...
  // Wrap in Providers to ensure ThemeProvider is available for AdminNav
  return (
    <Providers>
      <div className="h-screen flex bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-hidden relative">
        ...
        />
        <main className="flex-1 overflow-y-auto md:overflow-hidden relative z-0 text-gray-900 dark:text-white pt-[max(3.5rem,calc(3.5rem+env(safe-area-inset-top,0px)))] md:pt-0 min-h-0">
          {children}
        </main>
      </div>
    </Providers>
