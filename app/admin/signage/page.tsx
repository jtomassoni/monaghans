...
export default async function AdminSignagePage() {
  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 overflow-hidden relative">
      ...
      <div className="flex-shrink-0 px-2 sm:px-6 py-2 sm:py-5 pt-0 md:pt-5 border-b border-gray-200/60 dark:border-gray-800/60 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg shadow-sm relative z-10 overflow-x-auto">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4 min-w-0">
            <div className="hidden md:flex items-center gap-4 min-w-0 flex-1">
              <div className="p-3 bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 rounded-xl shadow-lg ring-2 ring-blue-500/20 flex-shrink-0">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
              ...
              <a
                ...
                className="flex items-center justify-center gap-1.5 sm:gap-2 p-2 sm:px-4 sm:py-2.5 bg-gradient-to-r from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-700 hover:from-gray-200 hover:to-gray-100 dark:hover:from-gray-700 dark:hover:to-gray-600 rounded-xl text-xs sm:text-sm font-semibold text-gray-700 dark:text-gray-200 transition-all shadow-sm hover:shadow-md border border-gray-200/50 dark:border-gray-700/50 min-w-[36px] sm:min-w-0"
                aria-label="Preview TV Display"
              >
                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                </svg>
                <span className="hidden sm:inline">Preview TV Display</span>
              </a>
            </div>
          </div>
        </div>
