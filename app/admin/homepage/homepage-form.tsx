...
export default function HomepageForm({ initialHero, initialAbout, initialGallery }: HomepageFormProps) {
  ...
  return (
    <div className="space-y-3">
      {/* Hero Section */}
      <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-300 dark:border-gray-600 shadow-md">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full px-3 py-1.5 text-sm bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded text-gray-900 dark:text-white cursor-text focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 resize-none"
      ...
      <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-300 dark:border-gray-600 shadow-md">
        <div className="flex justify-between items-center mb-3">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Gallery Section</h2>
          <div className="flex gap-2">
            {isGalleryDirty && (
              <button
                type="button"
