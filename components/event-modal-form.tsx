  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-2 sm:space-y-3">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center justify-end gap-1.5 shrink-0 pt-1.5 sm:pt-2 border-t border-gray-200 dark:border-gray-700">
            {event?.id && (
