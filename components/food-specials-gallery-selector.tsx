...
export default function FoodSpecialsGallerySelector({
  ...
  const modalContent = (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="flex-shrink-0 px-3 sm:px-6 py-3 sm:py-5 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-orange-50/50 to-transparent dark:from-orange-900/10">
          <div className="flex items-center justify-between gap-2 min-w-0">
            <div className="flex items-center gap-2 sm:gap-3 min-w-0">
              <div className="w-9 h-9 sm:w-10 sm:h-10 bg-orange-100 dark:bg-orange-900/30 rounded-lg flex items-center justify-center flex-shrink-0">
                <FaImage className="w-4 h-4 sm:w-5 sm:h-5 text-orange-600 dark:text-orange-400" />
              </div>
