...
export default function Navigation() {
  ...
  const onlineOrderingEnabled = useFeatureFlag('online_ordering');
  ...
  const menuItems: NavItem[] = [
    ...
    { href: '/menu', label: onlineOrderingEnabled ? 'Menu & Order' : 'Menu', icon: onlineOrderingEnabled ? 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z' : 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253', isLink: true },
    { href: orderingRedirectPath('online-ordering'), label: 'Order Pickup', icon: 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z', isLink: true },
    { href: '/events', label: 'Weekly Events', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', isLink: true },
    { href: '/private-events', label: 'Private Events', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z', isLink: true },
    ...
    <>
        ...
        <div className="max-w-6xl mx-auto px-4 py-3 sm:py-4">
          <div className="flex justify-between items-center">
                ...
                item.isLink ? (
                  item.external ? (
                    <a
                      ...
                      className="hover:text-[#F63440] transition text-white/90 cursor-pointer font-semibold"
                    >
                      {item.label}
                    </a>
                  ) : (
            ...
            <button
              ...
              className="md:hidden relative z-50 text-white p-2 -mr-2 rounded-lg hover:bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--color-accent)] focus:ring-offset-2 focus:ring-offset-black cursor-pointer"
      ...
      >
        ...
        >
                ...
                {item.isLink ? (
                  item.external ? (
                    <a
                      ...
                      rel="noopener noreferrer"
                      onClick={() => setMobileMenuOpen(false)}
                      className="flex items-center gap-4 px-6 py-4 bg-[#F63440]/20 hover:bg-[#F63440]/30 backdrop-blur-sm rounded-xl text-white text-lg font-semibold transition-all duration-200 hover:scale-105 hover:translate-x-2 border border-[#F63440]/40"
                    >
                      <svg className="w-6 h-6 text-[#F63440] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={item.icon} />
                      </svg>
                      <span>{item.label} on Grubhub</span>
          ...
          {/* Close hint */}
          <p className="mt-8 text-white/50 text-sm">Tap X to close</p>
        </div>
      </div>
    </>
  );
